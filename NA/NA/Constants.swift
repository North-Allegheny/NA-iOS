...
//  NA
//
//  Created by MITNICK, SHANE on 4/20/15.
...
class Constants: NSObject {
    ...
    class var THEME_COLOR = UIColor.clearColor
    class var THEME_COLOR = UIColor(red: 85/255.0, green: 85/255.0, blue: 85.255.0, alpha: 0.6)
    class var THEME_COLOR = UIColor(red: 62/255.0, green: 68/255.0, blue: 75/255.0, alpha: 1.0)
